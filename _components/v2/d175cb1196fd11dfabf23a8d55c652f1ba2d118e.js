...
function un0() {
  return /* @__PURE__ */ s(assetLogo0, { name: "United Nations logo", src: "/sundassayed/_assets/unitednations-logo.png", alt: "United Nations logo" });
}
function schrack0() {
  return /* @__PURE__ */ s(assetLogo0, { name: "Schrack Technik logo", src: "/sundassayed/_assets/schrackteknic-logo.png", alt: "Schrack Technik logo" });
}
function schiebel0() {
  return /* @__PURE__ */ s(assetLogo0, { name: "Schiebel logo", src: "/sundassayed/_assets/schiebel-logo.png", alt: "Schiebel logo" });
}
function glock0() {
  return /* @__PURE__ */ s(assetLogo0, { name: "GLOCK logo", src: "/sundassayed/_assets/glock-logo-grey.svg", alt: "GLOCK logo" });
}
function austro0() {
  return /* @__PURE__ */ s(assetLogo0, { name: "Austro Control logo", src: "/sundassayed/_assets/austrocontrol-logo.png", alt: "Austro Control logo" });
}
const b0 = [
  {
    id: "united-nations",
