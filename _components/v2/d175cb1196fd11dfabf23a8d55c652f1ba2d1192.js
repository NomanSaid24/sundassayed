...
function Jm({ children: e }) {
  const [t, i] = T("en"), n = oe((a) => {
    i(a === "en" || a === "es" || a === "ca" ? a : "en");
  }, []);
...
const expSchrack = "/sundassayed/_assets/experience/schrackteknicgmbh-experience.png", expWia = "/sundassayed/_assets/experience/wia-experience.png", expFit = "/sundassayed/_assets/experience/fit-experience.png", expMed = "/sundassayed/_assets/experience/medizintechnik-experience.png", expSchiebel = "/sundassayed/_assets/experience/schiebel-experience.png", expGlock = "/sundassayed/_assets/experience/glock-experience.png", expFfg = "/sundassayed/_assets/experience/ffg-experience.png", gl = expSchrack, hl = expMed, yl = expWia, xl = expFit, mo = "#00B6B6", vl = [0.22, 1, 0.36, 1], bl = 56, wl = 48, _i = wl + bl + 10, Xi = 16, hi = 72;
function Zn(e) {
  return [
    {
      id: "veepee",
      ...
      children: [
        ...
        /* @__PURE__ */ s(
          w.div,
          {
            initial: { opacity: 0, y: -10 },
            animate: o ? { opacity: 1, y: 0 } : {},
            transition: { duration: 0.7, delay: 0.2, ease: Ri },
            className: "sharing-love-slider-controls",
            style: {
              position: c ? "relative" : "absolute",
              top: c ? "auto" : "clamp(112px, 9vw, 132px)",
              right: c ? "auto" : "clamp(48px, 5vw, 76px)",
              zIndex: 12,
              display: "inline-flex",
              alignItems: "center",
              justifyContent: "center",
              gap: c ? "8px" : "10px",
              marginTop: c ? "-10px" : 0,
              marginBottom: c ? "18px" : 0,
              marginLeft: c ? "auto" : 0,
              marginRight: c ? "16px" : 0,
              padding: "4px",
              borderRadius: "999px",
              border: "1px solid rgba(0,182,182,0.38)",
              background: "linear-gradient(135deg, rgba(0,182,182,0.24), rgba(0,0,0,0.94) 42%, rgba(0,182,182,0.18))",
              boxShadow: "0 0 0 1px rgba(0,182,182,0.08), 0 0 28px rgba(0,182,182,0.28), inset 0 0 18px rgba(0,182,182,0.08)",
              backdropFilter: "blur(10px)",
              WebkitBackdropFilter: "blur(10px)"
            },
            children: [
              /* @__PURE__ */ s(
                "button",
                {
                  ...
                  style: {
                    ...
                    height: c ? "40px" : "44px",
                    borderRadius: "999px",
                    border: "1px solid rgba(0,182,182,0.34)",
                    background: "radial-gradient(circle at 50% 0%, rgba(0,182,182,0.18), rgba(0,0,0,0.92) 64%)",
                    color: "#00B6B6",
                    boxShadow: "inset 0 0 12px rgba(0,182,182,0.10), 0 0 14px rgba(0,182,182,0.14)",
                    fontFamily: "'Inter', sans-serif",
                    fontSize: "22px",
                    fontWeight: 700,
                    lineHeight: 1,
        ...
        .sharing-love-slider-controls button {
          transition: color 0.25s ease, border-color 0.25s ease, box-shadow 0.25s ease, transform 0.25s ease;
        }
        .sharing-love-slider-controls button:hover {
          color: #F2F2F2;
          border-color: rgba(0,182,182,0.72) !important;
          box-shadow: inset 0 0 14px rgba(0,182,182,0.18), 0 0 22px rgba(0,182,182,0.35) !important;
          transform: translateY(-1px);
        }
        .sharing-love-slider-controls button:focus-visible {
...
const st = [0.22, 1, 0.36, 1], B0 = [
  ...
  { id: "zh-CN", label: "Chinese Simplified", code: "ZH" },
  { id: "zh-TW", label: "Chinese Traditional", code: "ZH-T" },
  ...
  { id: "tl", label: "Filipino", code: "TL" },
  { id: "ar", label: "Arabic", code: "AR" },
  { id: "fa", label: "Persian", code: "FA" }
];
function M0(e = 768) {
  const [t, i] = T(!1);
  return B(() => {
...
function Sl({ style: e }) {
  const t = I(null), [i, n] = T(!1), [a, o] = T(() => {
    try {
      return typeof window < "u" && window.SundasTranslate?.current ? window.SundasTranslate.current() : localStorage.getItem("sundas-google-lang") || "en";
    } catch {
      return "en";
    }
  }), r = B0.find((u) => u.id === a) || B0[0], l = oe((u) => {
    o(u.id), n(!1);
    try {
      window.SundasTranslate?.select?.(u.id);
    } catch {
    }
  }, []);
  B(() => {
    const u = (m) => {
      t.current && !t.current.contains(m.target) && n(!1);
    }, m = (g) => {
      g.detail?.lang && o(g.detail.lang);
    };
    document.addEventListener("pointerdown", u), document.addEventListener("sundas:languagechange", m);
    try {
      window.SundasTranslate?.sync?.();
      window.SundasTranslate?.current && o(window.SundasTranslate.current());
    } catch {
    }
    return () => {
      document.removeEventListener("pointerdown", u), document.removeEventListener("sundas:languagechange", m);
    };
  }, []);
  return /* @__PURE__ */ p(
    "div",
    {
      ref: t,
      className: "notranslate sundas-google-lang-switcher",
      translate: "no",
      style: {
        position: "relative",
        pointerEvents: "auto",
        ...
        /* @__PURE__ */ p(
          "button",
          {
            ...
            style: {
              ...
              paddingRight: "10px",
              borderRadius: "999px",
              border: "1px solid rgba(0,182,182,0.42)",
              background: "linear-gradient(135deg, rgba(0,182,182,0.18), rgba(0,0,0,0.82) 48%, rgba(0,182,182,0.12))",
              color: "#FFFFFF",
              boxShadow: "0 0 0 1px rgba(0,182,182,0.08), 0 0 18px rgba(0,182,182,0.22), inset 0 0 14px rgba(0,182,182,0.08)",
              fontFamily: "'Inter', sans-serif",
              fontSize: "11px",
              fontWeight: 500,
            ...
            children: [
              /* @__PURE__ */ s("span", { style: { color: "#00B6B6", fontWeight: 700 }, children: "LANG" }),
              /* @__PURE__ */ s("span", { style: { opacity: 0.45 }, children: "/" }),
              /* @__PURE__ */ s("span", { className: "sundas-lang-code", children: r.code }),
              /* @__PURE__ */ s("span", { style: { color: "#00B6B6", fontSize: "10px", transform: i ? "rotate(180deg)" : "rotate(0deg)", transition: "transform 0.25s ease" }, children: "v" })
            ]
          }
        ),
        i && /* @__PURE__ */ s(
          "div",
          {
            className: "sundas-lang-dropdown",
            style: {
              position: "absolute",
              top: "calc(100% + 10px)",
              right: 0,
              ...
              padding: "8px",
              borderRadius: "14px",
              border: "1px solid rgba(0,182,182,0.26)",
              background: "rgba(4,8,8,0.96)",
              boxShadow: "0 18px 60px rgba(0,0,0,0.45), 0 0 30px rgba(0,182,182,0.18)",
            ...
            children: B0.map((u) => /* @__PURE__ */ p(
              "button",
              {
                ...
                style: {
                  ...
                  border: "none",
                  borderRadius: "10px",
                  background: a === u.id ? "rgba(0,182,182,0.16)" : "transparent",
                  color: "#FFFFFF",
                  paddingTop: "9px",
                  paddingBottom: "9px",
                  paddingLeft: "10px",
                ...
                children: [
                  ...
                  /* @__PURE__ */ s("span", { style: { color: "#00B6B6", fontSize: "11px", fontWeight: 700, letterSpacing: "0.12em" }, children: u.code })
                ]
              },
              u.id
            ))
